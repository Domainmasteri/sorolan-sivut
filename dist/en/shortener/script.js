document.addEventListener('DOMContentLoaded', () => {
    ...
    lomake.addEventListener('submit', async (e) => {
        ...
        lahetaBtn.innerText = "Processing...";
        ...
        try {
            ...
            if (data.success && data.shortUrl) {
                ...
                alert("Error: " + (data.error || "Creating the link failed"));
            }
        } catch (err) {
            ...
            lahetaBtn.innerText = `Wait ${sekuntejaJaljella}s...`;
            ...
            const ajastin = setInterval(() => {
                ...
                if (sekuntejaJaljella > 0) {
                    ...
                    lahetaBtn.innerText = "Shorten link";
